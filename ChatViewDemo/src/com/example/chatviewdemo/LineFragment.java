...
public class LineFragment extends Fragment {
	...
	private final String[] mLabelsOne = { "", "10-15", "", "15-20", "",
			"20-25", "", "25-30", "", "30-35", "" };
	...
	private final String[] mLabelsTwo = { "", "", "", "", "START", "", "", "",
			...
			"", "", "", "", "", "", "", "", "", "", "", "", "", "FINISH", "",
			"", "", "" };
	private final float[][] mValuesTwo = {
			{ 35f, 37f, 47f, 49f, 43f, 46f, 80f, 83f, 65f, 68f, 100f, 68f, 70f,
					73f, 83f, 85f, 70f, 73f, 73f, 77f, 33f, 15f, 18f, 25f, 28f,
					25f, 28f, 40f, 43f, 25f, 28f, 55f, 58f, 50f, 53f, 53f, 57f,
					48f, 50f, 53f, 54f, 25f, 27f, 35f, 37f, 35f, 80f, 82f, 55f,
					59f, 85f, 82f, 60f, 55f, 63f, 65f, 58f, 60f, 63f, 60f },
			{ 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f,
					85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f,
					85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f,
					85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f,
					85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f } };
	 ...
	 *            Play button
	 */
	private void dismissChart(final int tag, final LineChartView chart,
			final ImageButton btn) {
	...
	public void produceTwo(LineChartView chart, Runnable action) {
		...
		dataset.setColor(Color.WHITE).setThickness(Tools.fromDpToPx(3))
				.beginAt(4).endAt(55);
		chart.addData(dataset);
		...
		chart.setBorderSpacing(Tools.fromDpToPx(0))
				...
				.setYAxis(false).setAxisBorderValues(0, 125, 25)
				.setGrid(ChartView.GridType.HORIZONTAL, gridPaint);

		Animation anim = new Animation().setStartPoint(0, .5f).setEndAction(
				action);
	...
	public static void dismissTwo(LineChartView chart, Runnable action) {
		chart.dismiss(new Animation().setStartPoint(1, .5f)
				.setEndAction(action));
	}
	...
	public void produceThree(LineChartView chart, Runnable action) {
		...
		chart.setBorderSpacing(1).setAxisBorderValues(0, 10, 2)
				.setXLabels(AxisController.LabelPosition.OUTSIDE)
				.setYLabels(AxisController.LabelPosition.OUTSIDE)
				.setLabelsColor(Color.parseColor("#FF8E9196")).setXAxis(false)
				.setYAxis(false).setBorderSpacing(Tools.fromDpToPx(5))
